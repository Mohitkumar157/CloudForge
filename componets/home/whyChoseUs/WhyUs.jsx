    ...
    return (
        <section className='bg-[#c6bdab] py-16 md:py-20 lg:py-24'>
            ...
            <div className="container">
                <SecondHeading className={"md:text-center leading-[1.08]"} children={"Why leading companies choose our consulting"} />
                ...
                <Reveal>
                    <div className='grid gap-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1'>
                        ...
                        <div data-animate="scale-in" className='md:col-span-2'>
                            <ChartCard />
                        </div>
